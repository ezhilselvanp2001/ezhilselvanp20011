        ...
        <div className="bg-white rounded-lg shadow p-4 sm:p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl sm:text-2xl font-bold text-gray-900">$2,840</p>
            </div>
        ...
        <div className="bg-white rounded-lg shadow p-4 sm:p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl sm:text-2xl font-bold text-gray-900">$3,000</p>
            </div>
          ...
          <div className="mt-3 sm:mt-4 flex items-center">
            <span className="text-xs sm:text-sm text-green-600">$160 left</span>
        ...
        <div className="bg-white rounded-lg shadow p-4 sm:p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl sm:text-2xl font-bold text-gray-900">$5,200</p>
            </div>
