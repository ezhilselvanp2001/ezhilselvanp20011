  ...
  return (
    <div className="p-4 sm:p-6 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-1">Track your expenses and financial goals</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="mt-4 flex items-center">
            <span className="text-sm text-green-600">$160 left</span>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Monthly Spending vs Budget</h3>
        ...
        <div className="p-4 sm:p-6">
          <div className="space-y-4">
            {[
              ...
              <div key={transaction.id} className="flex items-center justify-between py-3 border-b border-gray-100 last:border-b-0 gap-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-sm text-gray-600 truncate">{transaction.category}</p>
                  </div>
                </div>
                <div className="text-right flex-shrink-0">
                  ...
                  <p className="text-sm text-gray-600 hidden sm:block">{transaction.date}</p>
                </div>
              </div>
            ))}
          </div>
