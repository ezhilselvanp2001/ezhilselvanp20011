          ...
          <div className="bg-white rounded-lg shadow">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-gray-900">Cash ({cashAccounts.length})</h2>
                  <p className="text-sm text-gray-500">Physical cash accounts</p>
                </div>
              </div>
            </div>
            ...
            {cashAccounts.length === 0 ? (
              <div className="p-8 text-center">
                ...
                <p className="text-gray-500">No cash accounts yet</p>
              </div>
            ) : (
